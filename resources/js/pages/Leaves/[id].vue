...
onMounted(() => {
    ...
    startTime.value = new Date(new Date().toLocaleDateString() + ' ' + dateTimeFrom[1])
    endTime.value = new Date(new Date().toLocaleDateString() + ' ' + dateTimeTo[1])
    removeBreak.value = props.leaveRequest?.remove_break_hours == 1
